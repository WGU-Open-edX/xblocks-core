...
from xblocks_contrib.problem.capa import customrender, inputtypes, responsetypes, xqueue_interface
...
from xblocks_contrib.problem.capa.util import (
    contextualize_text,
...
from xblocks_contrib.problem.xmlparser import XML
...
class LoncapaProblem:
    ...
    def __init__(  # pylint: disable=too-many-positional-arguments,too-many-arguments
        ...
        try:
            ...
            log.exception(
                "CAPAProblemError: %s, id:%s, data: %s", capa_block.display_name, self.problem_id, capa_block.data
            )
            raise
